    ...
    <div class="container blog-layout">
      ...
      <main class="blog-main-content">
        ...
        <div *ngIf="!isLoading">
          <div *ngIf="items.length > 0; else emptyState">
            <div class="article-list-card" *ngFor="let item of items">
              <div class="meta">
      ...
      <aside class="sidebar">
        ...
        <div class="glass-panel" style="padding: 24px; display: flex; flex-direction: column; gap: 12px;">
          <h4 style="font-size: 1.1rem; color: var(--text-main); font-family: 'Outfit', sans-serif; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 1px solid var(--border-glass); padding-bottom: 8px; margin-bottom: 8px;">
            Bölümler
          </h4>
