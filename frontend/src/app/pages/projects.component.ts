...
@Component({
  ...
  template: `
    <div class="container" style="padding-top: 40px; min-height: 70vh;">
      ...
      <div *ngIf="errorMessage" style="padding: 16px; background-color: rgba(239, 68, 68, 0.1); border: 1px solid var(--error); border-radius: var(--radius-sm); color: var(--error); text-align: center; margin-bottom: 24px;">
        {{ errorMessage }}
      </div>
      ...
      <div *ngIf="!isLoading" style="text-align: center; margin-top: 48px;">
        <a href="https://github.com/gefe35" target="_blank" class="btn btn-secondary" style="gap: 10px;">
